...
-------------------------------------------------------
--[[
對敵方全體造成140/160/180/200/220/230/250%(params1)傷害，並賦予"沉默"(params2)4秒(params3)、
"恐懼I/恐懼I/恐懼II/恐懼II/恐懼II/恐懼III/恐懼III"(params4)4秒(params5)
]]--
-------------------------------------------------------
function Skill_50011:castSkill(chaNode, skillType, skillId)
    --紀錄skill data
...
-- 提前計算技能目標用 不使用時回傳nil
function Skill_50011:calSkillTarget(chaNode, skillId)
    return nil
end
function Skill_50011:runSkill(chaNode, skillId, resultTable, allPassiveTable, targetTable, attack_params)
    local skillCfg = ConfigManager:getSkillCfg()[skillId]
...
function Skill_50011:getSkillTarget(chaNode, skillId)
