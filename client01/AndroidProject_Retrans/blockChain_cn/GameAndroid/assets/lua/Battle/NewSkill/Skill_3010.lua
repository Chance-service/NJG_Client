...
-------------------------------------------------------
--[[
開場時賦予敵方隨機目標"眷屬I/眷屬I/眷屬I/眷屬I"(params1)
]]--
-------------------------------------------------------
function Skill_3010:castSkill(chaNode, skillType, skillId)
    --紀錄skill data
...
-- 提前計算技能目標用 不使用時回傳nil
function Skill_3010:calSkillTarget(chaNode, skillId)
    return nil
end
function Skill_3010:runSkill(chaNode, skillId, resultTable, allPassiveTable, targetTable, attack_params)
    local skillCfg = ConfigManager:getSkillCfg()[skillId]
...
function Skill_3010:isUsable(chaNode, skillType, skillId, triggerType)
