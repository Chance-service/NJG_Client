...
-- SKILL
-------------------------------------------------------------------------------------------
function SkillManager:isSkillUsable(chaNode, skillType, skillId, triggerType)
    if not skillId then
        return false
    end
    ...
    return scripe["isUsable"] and scripe:isUsable(chaNode, skillType, skillId, triggerType)
end
