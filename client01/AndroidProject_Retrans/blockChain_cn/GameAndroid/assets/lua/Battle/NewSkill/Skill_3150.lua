...
-------------------------------------------------------
--[[
開場時賦予敵方隨機目標"崩壞I/崩壞I/崩壞I/崩壞I"(params1)
]]--
-------------------------------------------------------
function Skill_3150:castSkill(chaNode, skillType, skillId)
    --紀錄skill data
...
-- 提前計算技能目標用 不使用時回傳nil
function Skill_3150:calSkillTarget(chaNode, skillId)
    return nil
end
function Skill_3150:runSkill(chaNode, skillId, resultTable, allPassiveTable, targetTable, attack_params)
    local skillCfg = ConfigManager:getSkillCfg()[skillId]
...
function Skill_3150:isUsable(chaNode, skillType, skillId, triggerType)
