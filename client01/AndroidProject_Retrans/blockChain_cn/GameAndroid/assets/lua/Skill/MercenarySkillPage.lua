...
function SkillPageBase:onEnter(container)
	...
	--NewbieGuideManager.showHelpPage(GameConfig.HelpKey.HELP_MERCENARYSKILL)
end
	...
	for i=4, 1, -1 do
		...
		if i<= skillSize then
			...
			if skillItemId > 0 then
				...
				NodeHelper:setCCHTMLLabel(pItem,"mSkillTex",CCSize(570,96),skillCfg[skillItemId]["describe"],true)
				local sprite2Img = {
