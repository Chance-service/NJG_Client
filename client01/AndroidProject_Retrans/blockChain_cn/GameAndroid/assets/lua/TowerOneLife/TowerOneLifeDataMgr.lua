...
Inst.originTb = {
    {
        ...
        -- 分頁 相關
        scriptName = "TowerOneLife.TowerOneLifeSubPage_MainScene",
        iconImg_normal = "SubBtn_TowerFearless.png",
        iconImg_selected = "SubBtn_TowerFearless_On.png",
        ...
        -- 其他子頁資訊 ----------
        TopisVisible = false,
        activityID = Const_pb.ACTIVITY199_FearLess_TOWER
    },
}
Inst.SubPageCfgs = { }
...
function Inst:SetCfg()
    ...
    for _, MainData in pairs(MainCfg) do
        ...
        if tonumber(string.sub(groupId,1,3)) == 199 then
                -- 建立 group
