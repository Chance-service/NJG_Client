...
function CampMainPageBase:onEnter(container)
	...
	NewbieGuideManager.showHelpPage(GameConfig.HelpKey.HELP_CAMP)
end	
	...
	for i=1,4 do
		...
		if i<=arenaSkillSize then		
			...
			if skillId == 0 then 
				...
				local skillItemInfo = SkillManager:getSkillInfoBySkillIdEx( skillId )
...
function CampMainPageBase:onReturn(container)
