...
public class DownloadManagerPro {
     ...
     * </ul>
     */
    @SuppressLint("NewApi") public int[] getBytesAndStatus(long downloadId) {
     ...
     * @return
     */
    @SuppressLint("NewApi") private String getString(long downloadId, String columnName) {
        DownloadManager.Query query = new DownloadManager.Query().setFilterById(downloadId);
        String result = null;
        Cursor c = null;
        try {
     ...
     * @return
     */
    @SuppressLint("NewApi") private int getInt(long downloadId, String columnName) {
        DownloadManager.Query query = new DownloadManager.Query().setFilterById(downloadId);
        int result = -1;
        Cursor c = null;
        try {
