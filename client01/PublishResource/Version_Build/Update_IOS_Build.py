...
Version_Build_Native_Path_Mac = os.getenv('HOME') + '/Desktop/gjabd_svn_root/Version_Build'

run_cmd(CleanUp_cmdstr.substitute(PATH=Version_Build_Native_Path_Mac))
run_cmd(Revert_cmdstr.substitute(PATH=Version_Build_Native_Path_Mac))
run_cmd(Update_cmdstr.substitute(PATH=Version_Build_Native_Path_Mac))