...
local HPFORMATIONEDITREQ_ROLEID_FIELD = protobuf.FieldDescriptor();
local HPFORMATIONEDITREQ_STATUS_FIELD = protobuf.FieldDescriptor();
...
HPFORMATIONEDITREQ_ROLEID_FIELD.name = "roleId"
HPFORMATIONEDITREQ_ROLEID_FIELD.full_name = ".HPFormationEditReq.roleId"
HPFORMATIONEDITREQ_ROLEID_FIELD.number = 2
HPFORMATIONEDITREQ_ROLEID_FIELD.index = 1
HPFORMATIONEDITREQ_ROLEID_FIELD.label = 2
HPFORMATIONEDITREQ_ROLEID_FIELD.has_default_value = false
HPFORMATIONEDITREQ_ROLEID_FIELD.default_value = 0
HPFORMATIONEDITREQ_ROLEID_FIELD.type = 5
HPFORMATIONEDITREQ_ROLEID_FIELD.cpp_type = 1

HPFORMATIONEDITREQ_STATUS_FIELD.name = "status"
HPFORMATIONEDITREQ_STATUS_FIELD.full_name = ".HPFormationEditReq.status"
HPFORMATIONEDITREQ_STATUS_FIELD.number = 3
HPFORMATIONEDITREQ_STATUS_FIELD.index = 2
HPFORMATIONEDITREQ_STATUS_FIELD.label = 2
HPFORMATIONEDITREQ_STATUS_FIELD.has_default_value = false
HPFORMATIONEDITREQ_STATUS_FIELD.default_value = 0
HPFORMATIONEDITREQ_STATUS_FIELD.type = 5
HPFORMATIONEDITREQ_STATUS_FIELD.cpp_type = 1
...
HPFORMATIONEDITREQ.fields = {HPFORMATIONEDITREQ_INDEX_FIELD, HPFORMATIONEDITREQ_ROLEID_FIELD, HPFORMATIONEDITREQ_STATUS_FIELD}
