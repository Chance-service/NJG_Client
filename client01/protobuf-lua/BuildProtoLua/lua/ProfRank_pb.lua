...
local RANKITEMINFO_AVATARID_FIELD = protobuf.FieldDescriptor();
...
RANKITEMINFO_REBIRTHSTAGE_FIELD.number = 12
RANKITEMINFO_REBIRTHSTAGE_FIELD.index = 11
...
RANKITEMINFO_AVATARID_FIELD.name = "avatarId"
RANKITEMINFO_AVATARID_FIELD.full_name = ".RankItemInfo.avatarId"
RANKITEMINFO_AVATARID_FIELD.number = 13
RANKITEMINFO_AVATARID_FIELD.index = 12
RANKITEMINFO_AVATARID_FIELD.label = 1
RANKITEMINFO_AVATARID_FIELD.has_default_value = false
RANKITEMINFO_AVATARID_FIELD.default_value = 0
RANKITEMINFO_AVATARID_FIELD.type = 5
RANKITEMINFO_AVATARID_FIELD.cpp_type = 1

RANKITEMINFO_HEADICON_FIELD.name = "headIcon"
RANKITEMINFO_HEADICON_FIELD.full_name = ".RankItemInfo.headIcon"
RANKITEMINFO_HEADICON_FIELD.number = 14
RANKITEMINFO_HEADICON_FIELD.index = 13
RANKITEMINFO_HEADICON_FIELD.label = 1
...
RANKITEMINFO.fields = {RANKITEMINFO_CFGITEMID_FIELD, RANKITEMINFO_LEVEL_FIELD, RANKITEMINFO_NAME_FIELD, RANKITEMINFO_RANK_FIELD, RANKITEMINFO_FIGHTVALUE_FIELD, RANKITEMINFO_SIGNATURE_FIELD, RANKITEMINFO_PLAYERID_FIELD, RANKITEMINFO_TITLE_FIELD, RANKITEMINFO_ALLIANCENAME_FIELD, RANKITEMINFO_ALLIANCEID_FIELD, RANKITEMINFO_ROLEITEMID_FIELD, RANKITEMINFO_REBIRTHSTAGE_FIELD, RANKITEMINFO_AVATARID_FIELD, RANKITEMINFO_HEADICON_FIELD}
