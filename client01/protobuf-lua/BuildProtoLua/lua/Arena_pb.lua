...
local ARENAITEMINFO_MERCENARYID_FIELD = protobuf.FieldDescriptor();
local ARENAITEMINFO_REBIRTHSTAGE_FIELD = protobuf.FieldDescriptor();
local ARENAITEMINFO_AVATARID_FIELD = protobuf.FieldDescriptor();
...
local HPCHALLENGEDEFENDERRET_BATTLEINFO_FIELD = protobuf.FieldDescriptor();
...
ARENAITEMINFO_ALREADYBUYTIMES_FIELD.number = 18
...
ARENAITEMINFO_SIGNATURE_FIELD.index = 12
...
ARENAITEMINFO_TITLEID_FIELD.index = 13
...
ARENAITEMINFO_ALLIANCENAME_FIELD.index = 14
...
ARENAITEMINFO_ALLIANCEID_FIELD.index = 15
...
ARENAITEMINFO_ROLEITEMID_FIELD.index = 16
...
ARENAITEMINFO_MERCENARYID_FIELD.name = "mercenaryId"
ARENAITEMINFO_MERCENARYID_FIELD.full_name = ".ArenaItemInfo.mercenaryId"
ARENAITEMINFO_MERCENARYID_FIELD.number = 17
ARENAITEMINFO_MERCENARYID_FIELD.index = 17
ARENAITEMINFO_MERCENARYID_FIELD.label = 1
ARENAITEMINFO_MERCENARYID_FIELD.has_default_value = false
ARENAITEMINFO_MERCENARYID_FIELD.default_value = 0
ARENAITEMINFO_MERCENARYID_FIELD.type = 5
ARENAITEMINFO_MERCENARYID_FIELD.cpp_type = 1

ARENAITEMINFO_REBIRTHSTAGE_FIELD.name = "rebirthStage"
ARENAITEMINFO_REBIRTHSTAGE_FIELD.full_name = ".ArenaItemInfo.rebirthStage"
ARENAITEMINFO_REBIRTHSTAGE_FIELD.number = 19
ARENAITEMINFO_REBIRTHSTAGE_FIELD.index = 18
ARENAITEMINFO_REBIRTHSTAGE_FIELD.label = 1
ARENAITEMINFO_REBIRTHSTAGE_FIELD.has_default_value = false
ARENAITEMINFO_REBIRTHSTAGE_FIELD.default_value = 0
ARENAITEMINFO_REBIRTHSTAGE_FIELD.type = 5
ARENAITEMINFO_REBIRTHSTAGE_FIELD.cpp_type = 1

ARENAITEMINFO_AVATARID_FIELD.name = "avatarId"
ARENAITEMINFO_AVATARID_FIELD.full_name = ".ArenaItemInfo.avatarId"
ARENAITEMINFO_AVATARID_FIELD.number = 20
ARENAITEMINFO_AVATARID_FIELD.index = 19
ARENAITEMINFO_AVATARID_FIELD.label = 1
ARENAITEMINFO_AVATARID_FIELD.has_default_value = false
ARENAITEMINFO_AVATARID_FIELD.default_value = 0
ARENAITEMINFO_AVATARID_FIELD.type = 5
ARENAITEMINFO_AVATARID_FIELD.cpp_type = 1

ARENAITEMINFO_HEADICON_FIELD.name = "headIcon"
ARENAITEMINFO_HEADICON_FIELD.full_name = ".ArenaItemInfo.headIcon"
ARENAITEMINFO_HEADICON_FIELD.number = 21
ARENAITEMINFO_HEADICON_FIELD.index = 20
ARENAITEMINFO_HEADICON_FIELD.label = 1
ARENAITEMINFO_HEADICON_FIELD.has_default_value = false
ARENAITEMINFO_HEADICON_FIELD.default_value = ""
ARENAITEMINFO_HEADICON_FIELD.type = 9
ARENAITEMINFO_HEADICON_FIELD.cpp_type = 9

ARENAITEMINFO.name = "ArenaItemInfo"
ARENAITEMINFO.full_name = ".ArenaItemInfo"
ARENAITEMINFO.nested_types = {}
ARENAITEMINFO.enum_types = {}
ARENAITEMINFO.fields = {ARENAITEMINFO_IDENTITYTYPE_FIELD, ARENAITEMINFO_CFGITEMID_FIELD, ARENAITEMINFO_PLAYERID_FIELD, ARENAITEMINFO_LEVEL_FIELD, ARENAITEMINFO_NAME_FIELD, ARENAITEMINFO_PROF_FIELD, ARENAITEMINFO_RANK_FIELD, ARENAITEMINFO_FIGHTVALUE_FIELD, ARENAITEMINFO_RANKAWARDSSTR_FIELD, ARENAITEMINFO_SURPLUSCHALLENGETIMES_FIELD, ARENAITEMINFO_NEXTBUYPRICE_FIELD, ARENAITEMINFO_ALREADYBUYTIMES_FIELD, ARENAITEMINFO_SIGNATURE_FIELD, ARENAITEMINFO_TITLEID_FIELD, ARENAITEMINFO_ALLIANCENAME_FIELD, ARENAITEMINFO_ALLIANCEID_FIELD, ARENAITEMINFO_ROLEITEMID_FIELD, ARENAITEMINFO_MERCENARYID_FIELD, ARENAITEMINFO_REBIRTHSTAGE_FIELD, ARENAITEMINFO_AVATARID_FIELD, ARENAITEMINFO_HEADICON_FIELD}
...
HPCHALLENGEDEFENDERRET_BATTLEINFO_FIELD.name = "battleInfo"
HPCHALLENGEDEFENDERRET_BATTLEINFO_FIELD.full_name = ".HPChallengeDefenderRet.battleInfo"
HPCHALLENGEDEFENDERRET_BATTLEINFO_FIELD.number = 2
HPCHALLENGEDEFENDERRET_BATTLEINFO_FIELD.index = 1
HPCHALLENGEDEFENDERRET_BATTLEINFO_FIELD.label = 2
HPCHALLENGEDEFENDERRET_BATTLEINFO_FIELD.has_default_value = false
HPCHALLENGEDEFENDERRET_BATTLEINFO_FIELD.default_value = nil
HPCHALLENGEDEFENDERRET_BATTLEINFO_FIELD.message_type = BATTLE_PB_BATTLEINFO
HPCHALLENGEDEFENDERRET_BATTLEINFO_FIELD.type = 11
HPCHALLENGEDEFENDERRET_BATTLEINFO_FIELD.cpp_type = 10
...
HPCHALLENGEDEFENDERRET_PREOFCHALLENGERANK_FIELD.number = 3
HPCHALLENGEDEFENDERRET_PREOFCHALLENGERANK_FIELD.index = 2
...
HPCHALLENGEDEFENDERRET_AFTEROFCHALLENGERANK_FIELD.number = 4
HPCHALLENGEDEFENDERRET_AFTEROFCHALLENGERANK_FIELD.index = 3
...
HPCHALLENGEDEFENDERRET.fields = {HPCHALLENGEDEFENDERRET_CHALLENGERESULT_FIELD, HPCHALLENGEDEFENDERRET_BATTLEINFO_FIELD, HPCHALLENGEDEFENDERRET_PREOFCHALLENGERANK_FIELD, HPCHALLENGEDEFENDERRET_AFTEROFCHALLENGERANK_FIELD}
...
HPARENACHALLENGEREPORTRES_BATTLEINFO_FIELD.message_type = BATTLE_PB_BATTLEINFO
