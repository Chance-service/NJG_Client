...
const itemType itemType_MAX = BADGE;
...
const roleType roleType_MAX = MULTI_MONSTER;
...
const chatType chatType_MAX = CHAT_CROSS_PVP;
...
const RoleStatus RoleStatus_MAX = FIGHTING;
...
const ActivityId ActivityId_MAX = ACTIVITY142_EXCHANGE_SHOP;
...
const dailyRefreshType dailyRefreshType_MAX = WORLD_BOSS_BUFF_FREE_TIMES_2;
...
const QuestEventType QuestEventType_MAX = EIGHTEENPRINCES_PASS;
...
const HeroTokenMsgType HeroTokenMsgType_MAX = GEM_COMPOUND_ONCE;
...
const RankType RankType_MAX = SCORE_PROFCS_RANK;
...
enum MultiEliteState {
  IS_AWAIT = 1,
  IS_SETOUT = 2,
  IS_HOUSE_OWNER = 3
};
bool MultiEliteState_IsValid(int value);
const MultiEliteState MultiEliteState_MIN = IS_AWAIT;
const MultiEliteState MultiEliteState_MAX = IS_HOUSE_OWNER;
const int MultiEliteState_ARRAYSIZE = MultiEliteState_MAX + 1;

const ::google::protobuf::EnumDescriptor* MultiEliteState_descriptor();
inline const ::std::string& MultiEliteState_Name(MultiEliteState value) {
  return ::google::protobuf::internal::NameOfEnum(
    MultiEliteState_descriptor(), value);
}
inline bool MultiEliteState_Parse(
    const ::std::string& name, MultiEliteState* value) {
  return ::google::protobuf::internal::ParseNamedEnum<MultiEliteState>(
    MultiEliteState_descriptor(), name, value);
}
enum AddRoleAttrType {
  ONESELF = 0,
  MAIN_ROLE_AND_ONESELF = 1,
  ALL_ROLE = 2
};
bool AddRoleAttrType_IsValid(int value);
const AddRoleAttrType AddRoleAttrType_MIN = ONESELF;
const AddRoleAttrType AddRoleAttrType_MAX = ALL_ROLE;
const int AddRoleAttrType_ARRAYSIZE = AddRoleAttrType_MAX + 1;

const ::google::protobuf::EnumDescriptor* AddRoleAttrType_descriptor();
inline const ::std::string& AddRoleAttrType_Name(AddRoleAttrType value) {
  return ::google::protobuf::internal::NameOfEnum(
    AddRoleAttrType_descriptor(), value);
}
inline bool AddRoleAttrType_Parse(
    const ::std::string& name, AddRoleAttrType* value) {
  return ::google::protobuf::internal::ParseNamedEnum<AddRoleAttrType>(
    AddRoleAttrType_descriptor(), name, value);
}
enum WorldBossBuffType {
  ONESELF_TYPE = 1,
  MERCENARY_TYPE = 2,
  ALL_TYPE = 3
};
bool WorldBossBuffType_IsValid(int value);
const WorldBossBuffType WorldBossBuffType_MIN = ONESELF_TYPE;
const WorldBossBuffType WorldBossBuffType_MAX = ALL_TYPE;
const int WorldBossBuffType_ARRAYSIZE = WorldBossBuffType_MAX + 1;

const ::google::protobuf::EnumDescriptor* WorldBossBuffType_descriptor();
inline const ::std::string& WorldBossBuffType_Name(WorldBossBuffType value) {
  return ::google::protobuf::internal::NameOfEnum(
    WorldBossBuffType_descriptor(), value);
}
inline bool WorldBossBuffType_Parse(
    const ::std::string& name, WorldBossBuffType* value) {
  return ::google::protobuf::internal::ParseNamedEnum<WorldBossBuffType>(
    WorldBossBuffType_descriptor(), name, value);
}
enum ActionRecordType {
  RED_POINT_INTO = 1,
  MAIN_BANNER_INTO = 2,
...
const ActionRecordType ActionRecordType_MIN = RED_POINT_INTO;
const ActionRecordType ActionRecordType_MAX = GVG_ENTER;
const int ActionRecordType_ARRAYSIZE = ActionRecordType_MAX + 1;

const ::google::protobuf::EnumDescriptor* ActionRecordType_descriptor();
inline const ::std::string& ActionRecordType_Name(ActionRecordType value) {
  return ::google::protobuf::internal::NameOfEnum(
    ActionRecordType_descriptor(), value);
}
inline bool ActionRecordType_Parse(
    const ::std::string& name, ActionRecordType* value) {
  return ::google::protobuf::internal::ParseNamedEnum<ActionRecordType>(
    ActionRecordType_descriptor(), name, value);
}
enum ActionModuleId {
...
const ActionModuleId ActionModuleId_MIN = MODULE_MULTIELITE;
const ActionModuleId ActionModuleId_MAX = MODULE_GVG;
const int ActionModuleId_ARRAYSIZE = ActionModuleId_MAX + 1;

const ::google::protobuf::EnumDescriptor* ActionModuleId_descriptor();
inline const ::std::string& ActionModuleId_Name(ActionModuleId value) {
  return ::google::protobuf::internal::NameOfEnum(
    ActionModuleId_descriptor(), value);
}
inline bool ActionModuleId_Parse(
    const ::std::string& name, ActionModuleId* value) {
  return ::google::protobuf::internal::ParseNamedEnum<ActionModuleId>(
    ActionModuleId_descriptor(), name, value);
}
enum MutliNoticeType {
  START_TYPE = 1,
  SETOUT_TYPE = 2,
  INVITE_TYPE = 3
};
bool MutliNoticeType_IsValid(int value);
const MutliNoticeType MutliNoticeType_MIN = START_TYPE;
const MutliNoticeType MutliNoticeType_MAX = INVITE_TYPE;
const int MutliNoticeType_ARRAYSIZE = MutliNoticeType_MAX + 1;

const ::google::protobuf::EnumDescriptor* MutliNoticeType_descriptor();
inline const ::std::string& MutliNoticeType_Name(MutliNoticeType value) {
  return ::google::protobuf::internal::NameOfEnum(
    MutliNoticeType_descriptor(), value);
}
inline bool MutliNoticeType_Parse(
    const ::std::string& name, MutliNoticeType* value) {
  return ::google::protobuf::internal::ParseNamedEnum<MutliNoticeType>(
    MutliNoticeType_descriptor(), name, value);
}
enum HaremType {
  HAREM_TYPE_COMMON = 1,
  HAREM_TYPE_MIDDLE = 2,
...
const HaremType HaremType_MIN = HAREM_TYPE_COMMON;
const HaremType HaremType_MAX = HAREM_TYPE_LIMIT;
const int HaremType_ARRAYSIZE = HaremType_MAX + 1;

const ::google::protobuf::EnumDescriptor* HaremType_descriptor();
inline const ::std::string& HaremType_Name(HaremType value) {
  return ::google::protobuf::internal::NameOfEnum(
    HaremType_descriptor(), value);
}
inline bool HaremType_Parse(
    const ::std::string& name, HaremType* value) {
  return ::google::protobuf::internal::ParseNamedEnum<HaremType>(
    HaremType_descriptor(), name, value);
}
enum BossAutoBattleType {
  BOSS_NO_AUTO_TYPE = 0,
  BOSS_COMMON_TYPE = 1,
  BOSS_ADVANCED_TYPE = 2
};
bool BossAutoBattleType_IsValid(int value);
const BossAutoBattleType BossAutoBattleType_MIN = BOSS_NO_AUTO_TYPE;
const BossAutoBattleType BossAutoBattleType_MAX = BOSS_ADVANCED_TYPE;
const int BossAutoBattleType_ARRAYSIZE = BossAutoBattleType_MAX + 1;

const ::google::protobuf::EnumDescriptor* BossAutoBattleType_descriptor();
inline const ::std::string& BossAutoBattleType_Name(BossAutoBattleType value) {
  return ::google::protobuf::internal::NameOfEnum(
    BossAutoBattleType_descriptor(), value);
}
inline bool BossAutoBattleType_Parse(
    const ::std::string& name, BossAutoBattleType* value) {
  return ::google::protobuf::internal::ParseNamedEnum<BossAutoBattleType>(
    BossAutoBattleType_descriptor(), name, value);
}
enum WorldBossRankType {
  BOSS_PERSON_RANK_TYPE = 1,
  BOSS_LAST_KILL_RANT_TYPE = 2,
  BOSS_ALLIANCE_RANK_TYPE = 3
};
bool WorldBossRankType_IsValid(int value);
const WorldBossRankType WorldBossRankType_MIN = BOSS_PERSON_RANK_TYPE;
const WorldBossRankType WorldBossRankType_MAX = BOSS_ALLIANCE_RANK_TYPE;
const int WorldBossRankType_ARRAYSIZE = WorldBossRankType_MAX + 1;

const ::google::protobuf::EnumDescriptor* WorldBossRankType_descriptor();
inline const ::std::string& WorldBossRankType_Name(WorldBossRankType value) {
  return ::google::protobuf::internal::NameOfEnum(
    WorldBossRankType_descriptor(), value);
}
inline bool WorldBossRankType_Parse(
    const ::std::string& name, WorldBossRankType* value) {
  return ::google::protobuf::internal::ParseNamedEnum<WorldBossRankType>(
    WorldBossRankType_descriptor(), name, value);
}
enum WorldBossFailingType {
  NOT_PART = 0,
  HEAD_TYPE = 1,
  CHEST_TYPE = 2,
  HAUNCH_TYPE = 3
...
const WorldBossFailingType WorldBossFailingType_MIN = NOT_PART;
const WorldBossFailingType WorldBossFailingType_MAX = HAUNCH_TYPE;
const int WorldBossFailingType_ARRAYSIZE = WorldBossFailingType_MAX + 1;

const ::google::protobuf::EnumDescriptor* WorldBossFailingType_descriptor();
inline const ::std::string& WorldBossFailingType_Name(WorldBossFailingType value) {
  return ::google::protobuf::internal::NameOfEnum(
    WorldBossFailingType_descriptor(), value);
}
inline bool WorldBossFailingType_Parse(
    const ::std::string& name, WorldBossFailingType* value) {
  return ::google::protobuf::internal::ParseNamedEnum<WorldBossFailingType>(
    WorldBossFailingType_descriptor(), name, value);
}
enum WorldBossIsFree {
  WORLD_BOSS_FREE = 1,
  WORLD_BOSS_GOLD = 2
};
bool WorldBossIsFree_IsValid(int value);
const WorldBossIsFree WorldBossIsFree_MIN = WORLD_BOSS_FREE;
const WorldBossIsFree WorldBossIsFree_MAX = WORLD_BOSS_GOLD;
const int WorldBossIsFree_ARRAYSIZE = WorldBossIsFree_MAX + 1;

const ::google::protobuf::EnumDescriptor* WorldBossIsFree_descriptor();
inline const ::std::string& WorldBossIsFree_Name(WorldBossIsFree value) {
  return ::google::protobuf::internal::NameOfEnum(
    WorldBossIsFree_descriptor(), value);
}
inline bool WorldBossIsFree_Parse(
    const ::std::string& name, WorldBossIsFree* value) {
  return ::google::protobuf::internal::ParseNamedEnum<WorldBossIsFree>(
    WorldBossIsFree_descriptor(), name, value);
}
enum EquipEnhanceType {
  EQUIP_ONCE = 1,
  EQUIP_TEN_TIMES = 2
};
bool EquipEnhanceType_IsValid(int value);
const EquipEnhanceType EquipEnhanceType_MIN = EQUIP_ONCE;
const EquipEnhanceType EquipEnhanceType_MAX = EQUIP_TEN_TIMES;
const int EquipEnhanceType_ARRAYSIZE = EquipEnhanceType_MAX + 1;

const ::google::protobuf::EnumDescriptor* EquipEnhanceType_descriptor();
inline const ::std::string& EquipEnhanceType_Name(EquipEnhanceType value) {
  return ::google::protobuf::internal::NameOfEnum(
    EquipEnhanceType_descriptor(), value);
}
inline bool EquipEnhanceType_Parse(
    const ::std::string& name, EquipEnhanceType* value) {
  return ::google::protobuf::internal::ParseNamedEnum<EquipEnhanceType>(
    EquipEnhanceType_descriptor(), name, value);
}
enum SevenDayEventType {
  LOGIN = 1,
  RECHARGE = 2,
  LEVELUP = 3,
  CHALLENGE = 4,
...
const SevenDayEventType SevenDayEventType_MIN = LOGIN;
const SevenDayEventType SevenDayEventType_MAX = MAINROLE_SCORE;
const int SevenDayEventType_ARRAYSIZE = SevenDayEventType_MAX + 1;

const ::google::protobuf::EnumDescriptor* SevenDayEventType_descriptor();
inline const ::std::string& SevenDayEventType_Name(SevenDayEventType value) {
  return ::google::protobuf::internal::NameOfEnum(
    SevenDayEventType_descriptor(), value);
}
inline bool SevenDayEventType_Parse(
    const ::std::string& name, SevenDayEventType* value) {
  return ::google::protobuf::internal::ParseNamedEnum<SevenDayEventType>(
    SevenDayEventType_descriptor(), name, value);
}
enum LoginSignAwdType {
  SIGNAWARD = 1,
  SIGNOPENCHEST = 2
};
bool LoginSignAwdType_IsValid(int value);
const LoginSignAwdType LoginSignAwdType_MIN = SIGNAWARD;
const LoginSignAwdType LoginSignAwdType_MAX = SIGNOPENCHEST;
const int LoginSignAwdType_ARRAYSIZE = LoginSignAwdType_MAX + 1;

const ::google::protobuf::EnumDescriptor* LoginSignAwdType_descriptor();
inline const ::std::string& LoginSignAwdType_Name(LoginSignAwdType value) {
  return ::google::protobuf::internal::NameOfEnum(
    LoginSignAwdType_descriptor(), value);
}
inline bool LoginSignAwdType_Parse(
    const ::std::string& name, LoginSignAwdType* value) {
  return ::google::protobuf::internal::ParseNamedEnum<LoginSignAwdType>(
    LoginSignAwdType_descriptor(), name, value);
}
enum EighteenPrincesLayerStatus {
  NOT_OPEN = 0,
  CAN_CHANLLENGE = 1,
  ALL_PASS = 2
};
bool EighteenPrincesLayerStatus_IsValid(int value);
const EighteenPrincesLayerStatus EighteenPrincesLayerStatus_MIN = NOT_OPEN;
const EighteenPrincesLayerStatus EighteenPrincesLayerStatus_MAX = ALL_PASS;
const int EighteenPrincesLayerStatus_ARRAYSIZE = EighteenPrincesLayerStatus_MAX + 1;

const ::google::protobuf::EnumDescriptor* EighteenPrincesLayerStatus_descriptor();
inline const ::std::string& EighteenPrincesLayerStatus_Name(EighteenPrincesLayerStatus value) {
  return ::google::protobuf::internal::NameOfEnum(
    EighteenPrincesLayerStatus_descriptor(), value);
}
inline bool EighteenPrincesLayerStatus_Parse(
    const ::std::string& name, EighteenPrincesLayerStatus* value) {
  return ::google::protobuf::internal::ParseNamedEnum<EighteenPrincesLayerStatus>(
    EighteenPrincesLayerStatus_descriptor(), name, value);
}
enum EighteenPrincesMedicalKitTYPE {
  BIGMEDICALKIT = 1,
  MIDLEMEDICALKIT = 2,
  SMALLMEDICALKIT = 3
};
bool EighteenPrincesMedicalKitTYPE_IsValid(int value);
const EighteenPrincesMedicalKitTYPE EighteenPrincesMedicalKitTYPE_MIN = BIGMEDICALKIT;
const EighteenPrincesMedicalKitTYPE EighteenPrincesMedicalKitTYPE_MAX = SMALLMEDICALKIT;
const int EighteenPrincesMedicalKitTYPE_ARRAYSIZE = EighteenPrincesMedicalKitTYPE_MAX + 1;

const ::google::protobuf::EnumDescriptor* EighteenPrincesMedicalKitTYPE_descriptor();
inline const ::std::string& EighteenPrincesMedicalKitTYPE_Name(EighteenPrincesMedicalKitTYPE value) {
  return ::google::protobuf::internal::NameOfEnum(
    EighteenPrincesMedicalKitTYPE_descriptor(), value);
}
inline bool EighteenPrincesMedicalKitTYPE_Parse(
    const ::std::string& name, EighteenPrincesMedicalKitTYPE* value) {
  return ::google::protobuf::internal::ParseNamedEnum<EighteenPrincesMedicalKitTYPE>(
    EighteenPrincesMedicalKitTYPE_descriptor(), name, value);
}
enum BadgeAttrGrade {
...
const BadgeAttrGrade BadgeAttrGrade_MIN = BADGE_PRIMARY_ATTR;
const BadgeAttrGrade BadgeAttrGrade_MAX = BADGE_EXTRA_ATTR;
const int BadgeAttrGrade_ARRAYSIZE = BadgeAttrGrade_MAX + 1;

const ::google::protobuf::EnumDescriptor* BadgeAttrGrade_descriptor();
inline const ::std::string& BadgeAttrGrade_Name(BadgeAttrGrade value) {
  return ::google::protobuf::internal::NameOfEnum(
    BadgeAttrGrade_descriptor(), value);
}
inline bool BadgeAttrGrade_Parse(
    const ::std::string& name, BadgeAttrGrade* value) {
  return ::google::protobuf::internal::ParseNamedEnum<BadgeAttrGrade>(
    BadgeAttrGrade_descriptor(), name, value);
}
enum BadgeType {
  POWERFUL_BADGE = 1,
  COURAGE_BADGE = 2,
...
const BadgeType BadgeType_MIN = POWERFUL_BADGE;
const BadgeType BadgeType_MAX = QUICK_BADGE;
...
const BadgeQuality BadgeQuality_MIN = GREEN_BADGE;
const BadgeQuality BadgeQuality_MAX = RED_BADGE;
const int BadgeQuality_ARRAYSIZE = BadgeQuality_MAX + 1;

const ::google::protobuf::EnumDescriptor* BadgeQuality_descriptor();
inline const ::std::string& BadgeQuality_Name(BadgeQuality value) {
  return ::google::protobuf::internal::NameOfEnum(
    BadgeQuality_descriptor(), value);
}
inline bool BadgeQuality_Parse(
    const ::std::string& name, BadgeQuality* value) {
  return ::google::protobuf::internal::ParseNamedEnum<BadgeQuality>(
    BadgeQuality_descriptor(), name, value);
}
// ===================================================================
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::MultiEliteState>() {
  return ::MultiEliteState_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::AddRoleAttrType>() {
  return ::AddRoleAttrType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::WorldBossBuffType>() {
  return ::WorldBossBuffType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::ActionRecordType>() {
  return ::ActionRecordType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::ActionModuleId>() {
  return ::ActionModuleId_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::MutliNoticeType>() {
  return ::MutliNoticeType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::HaremType>() {
  return ::HaremType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::BossAutoBattleType>() {
  return ::BossAutoBattleType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::WorldBossRankType>() {
  return ::WorldBossRankType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::WorldBossFailingType>() {
  return ::WorldBossFailingType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::WorldBossIsFree>() {
  return ::WorldBossIsFree_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::EquipEnhanceType>() {
  return ::EquipEnhanceType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::SevenDayEventType>() {
  return ::SevenDayEventType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::LoginSignAwdType>() {
  return ::LoginSignAwdType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::EighteenPrincesLayerStatus>() {
  return ::EighteenPrincesLayerStatus_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::EighteenPrincesMedicalKitTYPE>() {
  return ::EighteenPrincesMedicalKitTYPE_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::BadgeAttrGrade>() {
  return ::BadgeAttrGrade_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::BadgeType>() {
  return ::BadgeType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::BadgeQuality>() {
  return ::BadgeQuality_descriptor();
}
