...
+ (id)showAlertWithTitle:(NSString *)title message:(NSString *)message content:(NSString *)content delegate:(id)delegate customizationBlock:(void (^)(WCAlertView *alertView))customization completionBlock:(void (^)(NSUInteger buttonIndex, WCAlertView *alertView))block cancelButtonTitle:(NSString *)cancelButtonTitle otherButtonTitles:(NSString *)otherButtonTitles, ...
{

    /*WCAlertView *alertView = [[self alloc] initWithTitle:title message:message content:content completionBlock:block cancelButtonTitle:cancelButtonTitle otherButtonTitles:nil];*/
    
    WCAlertView *alertView = [[self alloc] initWithTitle:title message:message content:content delegate:delegate cancelButtonTitle:cancelButtonTitle otherButtonTitles:nil];
...
- (id)initWithTitle:(NSString *)title message:(NSString *)message content:(NSString *)content delegate:(id)delegate cancelButtonTitle:(NSString *)cancelButtonTitle otherButtonTitles:(NSString *)otherButtonTitles, ...
{
...
- (id)initWithTitle:(NSString *)title message:(NSString *)message content:(NSString *)content completionBlock:(void (^)(NSUInteger buttonIndex, WCAlertView *alertView))block cancelButtonTitle:(NSString *)cancelButtonTitle otherButtonTitles:(NSString *)otherButtonTitles, ... {
