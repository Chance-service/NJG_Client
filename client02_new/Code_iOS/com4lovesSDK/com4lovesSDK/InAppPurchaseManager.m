...
@interface InAppPurchaseManager()
{
    ...
    NSString* nowBroughtPruductID;
    float nowBroughtProductPrice;
    NSString* lastBroughtPruductID;
    float lastBroughtProductPrice;
...
{
    return lastBroughtPruductID;
}
- (float) getLastProductPrice
{
    return lastBroughtProductPrice;
}
#pragma -
...
- (void)finishTransaction:(SKPaymentTransaction *)transaction wasSuccessful:(BOOL)wasSuccessful
{
    ...
    if (wasSuccessful)
    {
        ...
        lastBroughtReceipt = [NSData dataWithContentsOfURL:receiptURL];
        
        //lastBroughtPruductID = nowBroughtPruductID;
        //lastBroughtProductPrice = nowBroughtProductPrice;
        //通知 notification kInAppPurchaseManagerTransactionSucceededNotification 注册的方法是 iapBuyDone
    ...
    else
    {
        ...
        UIAlertView* alert = [[UIAlertView alloc]initWithTitle:@"Buy Fail"
                                                       message:@"Buy Fail"
                                                      delegate:self
