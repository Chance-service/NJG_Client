...
// #endif
	...
	std::string getHttpImgName(){return mHttpImgName;}
	...
	std::string getCurAnimationDoneName(){ return mAnimName; }
	virtual std::string dumpInfo();
private:
	std::string mScriptFileName;
	int mScriptFunHandler;
	cocos2d::extension::CCReViSvItemData* mItemDate;
	std::string mHttpImgName;
	bool mIsHttpImgListener;
