...
"severs" :
[
{"id":1, "name":"һ����˳" , "address":"127.0.0.1", "port":9999, "state":"full"},
{"id":2, "name":"������ͷ" , "address":"127.0.0.1", "port":9998, "state":"general"},
{"id":3, "name":"�����˳" , "address":"127.0.0.1", "port":9998, "state":"new"},
]
} 
...
public:
	...
	enum CHECK_STATE
	{
		...
		//
		//���⣬û���ŻҶȺš��ڲ��Ž��룬�ݲ�ʵ��
		//CS_SERVER_STATE_WAITING,	//xinzheng 2013-07-15 ��server������������ ��ʾ����GameServer�ĵ�ǰ״̬��1������0��һ��msg��ֹ����
		//
	};
...
private:
	...
	std::string mCfgFilePath;	//bundle��version_xx.cfg�ļ�ȫ·��
	...
	bool mIsFirstUpdate;//�Ƿ��һ���ڸ���
	bool mIsOpenDataTransfer;//�Ƿ�������
	...
	int downloadServerFileTimes;  //���ط������б��Ĵ���
