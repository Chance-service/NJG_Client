...
private:
	...
	/**should delete buffer after use*/
	bool UnpackPacket(void*buffer , int length, int cCompress);
	static std::string UnpackPacket(int opcode, void *buffer, int _length,int cCompress);
};
