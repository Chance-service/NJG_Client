...
public:
	...
	virtual void onContolAction(const std::string& itemName, CCObject* sender, std::string tag){};
...
private:
	...
	virtual extension::SEL_CCControlHandler onResolveCCBCCControlSelectorWithSender(CCObject * pTarget, const char* pSelectorName, CCNode* sender);
	...
	void _menuItemClickedForCCControl(CCObject * pSender,unsigned int eventType);
