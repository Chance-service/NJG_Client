...
extern "C"
{
	...
	extern void playOtherBackgroundMusicJNI(const char *path, bool isLoop);
    extern void stopBackgroundMusicJNI();
	extern void stopOtherBackgroundMusicJNI();
    ...
    extern void endJNI();
	extern bool isOtherBackgroundMusicPlayingJNI();
}
