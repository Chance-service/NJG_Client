...
function TowerRankBase:refresh(container)
    ...
    StringTable["mSelfTxt"]= common:getLanguageString("@SeasonTowerXstage",SelfTable.selfFloor-1) .." ".. os.date("%Y/%m/%d %H:%M:%S", math.floor(SelfTable.selfDoneTime/1000))
...
function RankingContent:onRefreshContent(ccbRoot)
    ...
    local timeTxt = common:getLanguageString("@SeasonTowerXstage",self.data.MaxFloor-1) .." "..os.date("%Y/%m/%d %H:%M:%S", math.floor(self.data.doneTime/1000))
