...
local SHOPITEMINFOINIT_ENDTIME_FIELD = protobuf.FieldDescriptor();
...
ECOINREQUEST = protobuf.Descriptor();
local ECOINREQUEST_TOKEN_FIELD = protobuf.FieldDescriptor();
ECOINRESPONSE = protobuf.Descriptor();
local ECOINRESPONSE_COINS_FIELD = protobuf.FieldDescriptor();
ECOINBUYREQUEST = protobuf.Descriptor();
local ECOINBUYREQUEST_TOKEN_FIELD = protobuf.FieldDescriptor();
local ECOINBUYREQUEST_PID_FIELD = protobuf.FieldDescriptor();
ECOINBUYRESPONSE = protobuf.Descriptor();
local ECOINBUYRESPONSE_RESULT_FIELD = protobuf.FieldDescriptor();
local ECOINBUYRESPONSE_REFNO_FIELD = protobuf.FieldDescriptor();
local ECOINBUYRESPONSE_COSTMONEY_FIELD = protobuf.FieldDescriptor();
PLATFORMGETGOODS = protobuf.Descriptor();
local PLATFORMGETGOODS_ORDERID_FIELD = protobuf.FieldDescriptor();
local PLATFORMGETGOODS_GOODSID_FIELD = protobuf.FieldDescriptor();
local PLATFORMGETGOODS_TOKEN_FIELD = protobuf.FieldDescriptor();
PLATFORMORDERNOTICE = protobuf.Descriptor();
local PLATFORMORDERNOTICE_ORDERID_FIELD = protobuf.FieldDescriptor();
local PLATFORMORDERNOTICE_STATUS_FIELD = protobuf.FieldDescriptor();
...
SHOPITEMINFOINIT_ENDTIME_FIELD.name = "endTime"
SHOPITEMINFOINIT_ENDTIME_FIELD.full_name = ".ShopItemInfoInit.endTime"
SHOPITEMINFOINIT_ENDTIME_FIELD.number = 11
SHOPITEMINFOINIT_ENDTIME_FIELD.index = 10
SHOPITEMINFOINIT_ENDTIME_FIELD.label = 1
SHOPITEMINFOINIT_ENDTIME_FIELD.has_default_value = false
SHOPITEMINFOINIT_ENDTIME_FIELD.default_value = 0
SHOPITEMINFOINIT_ENDTIME_FIELD.type = 3
SHOPITEMINFOINIT_ENDTIME_FIELD.cpp_type = 2
...
ECOINREQUEST_TOKEN_FIELD.name = "token"
ECOINREQUEST_TOKEN_FIELD.full_name = ".ECoinRequest.token"
ECOINREQUEST_TOKEN_FIELD.number = 1
ECOINREQUEST_TOKEN_FIELD.index = 0
ECOINREQUEST_TOKEN_FIELD.label = 2
ECOINREQUEST_TOKEN_FIELD.has_default_value = false
ECOINREQUEST_TOKEN_FIELD.default_value = ""
ECOINREQUEST_TOKEN_FIELD.type = 9
ECOINREQUEST_TOKEN_FIELD.cpp_type = 9

ECOINREQUEST.name = "ECoinRequest"
ECOINREQUEST.full_name = ".ECoinRequest"
ECOINREQUEST.nested_types = {}
ECOINREQUEST.enum_types = {}
ECOINREQUEST.fields = {ECOINREQUEST_TOKEN_FIELD}
ECOINREQUEST.is_extendable = false
ECOINREQUEST.extensions = {}
ECOINRESPONSE_COINS_FIELD.name = "coins"
ECOINRESPONSE_COINS_FIELD.full_name = ".ECoinResponse.coins"
ECOINRESPONSE_COINS_FIELD.number = 1
ECOINRESPONSE_COINS_FIELD.index = 0
ECOINRESPONSE_COINS_FIELD.label = 2
ECOINRESPONSE_COINS_FIELD.has_default_value = false
ECOINRESPONSE_COINS_FIELD.default_value = 0
ECOINRESPONSE_COINS_FIELD.type = 5
ECOINRESPONSE_COINS_FIELD.cpp_type = 1

ECOINRESPONSE.name = "ECoinResponse"
ECOINRESPONSE.full_name = ".ECoinResponse"
ECOINRESPONSE.nested_types = {}
ECOINRESPONSE.enum_types = {}
ECOINRESPONSE.fields = {ECOINRESPONSE_COINS_FIELD}
ECOINRESPONSE.is_extendable = false
ECOINRESPONSE.extensions = {}
ECOINBUYREQUEST_TOKEN_FIELD.name = "token"
ECOINBUYREQUEST_TOKEN_FIELD.full_name = ".ECoinBuyRequest.token"
ECOINBUYREQUEST_TOKEN_FIELD.number = 1
ECOINBUYREQUEST_TOKEN_FIELD.index = 0
ECOINBUYREQUEST_TOKEN_FIELD.label = 2
ECOINBUYREQUEST_TOKEN_FIELD.has_default_value = false
ECOINBUYREQUEST_TOKEN_FIELD.default_value = ""
ECOINBUYREQUEST_TOKEN_FIELD.type = 9
ECOINBUYREQUEST_TOKEN_FIELD.cpp_type = 9

ECOINBUYREQUEST_PID_FIELD.name = "pid"
ECOINBUYREQUEST_PID_FIELD.full_name = ".ECoinBuyRequest.pid"
ECOINBUYREQUEST_PID_FIELD.number = 2
ECOINBUYREQUEST_PID_FIELD.index = 1
ECOINBUYREQUEST_PID_FIELD.label = 2
ECOINBUYREQUEST_PID_FIELD.has_default_value = false
ECOINBUYREQUEST_PID_FIELD.default_value = 0
ECOINBUYREQUEST_PID_FIELD.type = 5
ECOINBUYREQUEST_PID_FIELD.cpp_type = 1

ECOINBUYREQUEST.name = "ECoinBuyRequest"
ECOINBUYREQUEST.full_name = ".ECoinBuyRequest"
ECOINBUYREQUEST.nested_types = {}
ECOINBUYREQUEST.enum_types = {}
ECOINBUYREQUEST.fields = {ECOINBUYREQUEST_TOKEN_FIELD, ECOINBUYREQUEST_PID_FIELD}
ECOINBUYREQUEST.is_extendable = false
ECOINBUYREQUEST.extensions = {}
ECOINBUYRESPONSE_RESULT_FIELD.name = "result"
ECOINBUYRESPONSE_RESULT_FIELD.full_name = ".ECoinBuyResponse.result"
ECOINBUYRESPONSE_RESULT_FIELD.number = 1
ECOINBUYRESPONSE_RESULT_FIELD.index = 0
ECOINBUYRESPONSE_RESULT_FIELD.label = 2
ECOINBUYRESPONSE_RESULT_FIELD.has_default_value = false
ECOINBUYRESPONSE_RESULT_FIELD.default_value = 0
ECOINBUYRESPONSE_RESULT_FIELD.type = 5
ECOINBUYRESPONSE_RESULT_FIELD.cpp_type = 1

ECOINBUYRESPONSE_REFNO_FIELD.name = "refno"
ECOINBUYRESPONSE_REFNO_FIELD.full_name = ".ECoinBuyResponse.refno"
ECOINBUYRESPONSE_REFNO_FIELD.number = 2
ECOINBUYRESPONSE_REFNO_FIELD.index = 1
ECOINBUYRESPONSE_REFNO_FIELD.label = 2
ECOINBUYRESPONSE_REFNO_FIELD.has_default_value = false
ECOINBUYRESPONSE_REFNO_FIELD.default_value = ""
ECOINBUYRESPONSE_REFNO_FIELD.type = 9
ECOINBUYRESPONSE_REFNO_FIELD.cpp_type = 9

ECOINBUYRESPONSE_COSTMONEY_FIELD.name = "costmoney"
ECOINBUYRESPONSE_COSTMONEY_FIELD.full_name = ".ECoinBuyResponse.costmoney"
ECOINBUYRESPONSE_COSTMONEY_FIELD.number = 3
ECOINBUYRESPONSE_COSTMONEY_FIELD.index = 2
ECOINBUYRESPONSE_COSTMONEY_FIELD.label = 1
ECOINBUYRESPONSE_COSTMONEY_FIELD.has_default_value = false
ECOINBUYRESPONSE_COSTMONEY_FIELD.default_value = 0
ECOINBUYRESPONSE_COSTMONEY_FIELD.type = 5
ECOINBUYRESPONSE_COSTMONEY_FIELD.cpp_type = 1

ECOINBUYRESPONSE.name = "ECoinBuyResponse"
ECOINBUYRESPONSE.full_name = ".ECoinBuyResponse"
ECOINBUYRESPONSE.nested_types = {}
ECOINBUYRESPONSE.enum_types = {}
ECOINBUYRESPONSE.fields = {ECOINBUYRESPONSE_RESULT_FIELD, ECOINBUYRESPONSE_REFNO_FIELD, ECOINBUYRESPONSE_COSTMONEY_FIELD}
ECOINBUYRESPONSE.is_extendable = false
ECOINBUYRESPONSE.extensions = {}
PLATFORMGETGOODS_ORDERID_FIELD.name = "orderid"
PLATFORMGETGOODS_ORDERID_FIELD.full_name = ".PlatformGetGoods.orderid"
PLATFORMGETGOODS_ORDERID_FIELD.number = 1
PLATFORMGETGOODS_ORDERID_FIELD.index = 0
PLATFORMGETGOODS_ORDERID_FIELD.label = 2
PLATFORMGETGOODS_ORDERID_FIELD.has_default_value = false
PLATFORMGETGOODS_ORDERID_FIELD.default_value = ""
PLATFORMGETGOODS_ORDERID_FIELD.type = 9
PLATFORMGETGOODS_ORDERID_FIELD.cpp_type = 9

PLATFORMGETGOODS_GOODSID_FIELD.name = "goodsId"
PLATFORMGETGOODS_GOODSID_FIELD.full_name = ".PlatformGetGoods.goodsId"
PLATFORMGETGOODS_GOODSID_FIELD.number = 2
PLATFORMGETGOODS_GOODSID_FIELD.index = 1
PLATFORMGETGOODS_GOODSID_FIELD.label = 2
PLATFORMGETGOODS_GOODSID_FIELD.has_default_value = false
PLATFORMGETGOODS_GOODSID_FIELD.default_value = 0
PLATFORMGETGOODS_GOODSID_FIELD.type = 5
PLATFORMGETGOODS_GOODSID_FIELD.cpp_type = 1

PLATFORMGETGOODS_TOKEN_FIELD.name = "token"
PLATFORMGETGOODS_TOKEN_FIELD.full_name = ".PlatformGetGoods.token"
PLATFORMGETGOODS_TOKEN_FIELD.number = 3
PLATFORMGETGOODS_TOKEN_FIELD.index = 2
PLATFORMGETGOODS_TOKEN_FIELD.label = 2
PLATFORMGETGOODS_TOKEN_FIELD.has_default_value = false
PLATFORMGETGOODS_TOKEN_FIELD.default_value = ""
PLATFORMGETGOODS_TOKEN_FIELD.type = 9
PLATFORMGETGOODS_TOKEN_FIELD.cpp_type = 9

PLATFORMGETGOODS.name = "PlatformGetGoods"
PLATFORMGETGOODS.full_name = ".PlatformGetGoods"
PLATFORMGETGOODS.nested_types = {}
PLATFORMGETGOODS.enum_types = {}
PLATFORMGETGOODS.fields = {PLATFORMGETGOODS_ORDERID_FIELD, PLATFORMGETGOODS_GOODSID_FIELD, PLATFORMGETGOODS_TOKEN_FIELD}
PLATFORMGETGOODS.is_extendable = false
PLATFORMGETGOODS.extensions = {}
PLATFORMORDERNOTICE_ORDERID_FIELD.name = "orderid"
PLATFORMORDERNOTICE_ORDERID_FIELD.full_name = ".PlatformOrderNotice.orderid"
PLATFORMORDERNOTICE_ORDERID_FIELD.number = 1
PLATFORMORDERNOTICE_ORDERID_FIELD.index = 0
PLATFORMORDERNOTICE_ORDERID_FIELD.label = 2
PLATFORMORDERNOTICE_ORDERID_FIELD.has_default_value = false
PLATFORMORDERNOTICE_ORDERID_FIELD.default_value = ""
PLATFORMORDERNOTICE_ORDERID_FIELD.type = 9
PLATFORMORDERNOTICE_ORDERID_FIELD.cpp_type = 9

PLATFORMORDERNOTICE_STATUS_FIELD.name = "status"
PLATFORMORDERNOTICE_STATUS_FIELD.full_name = ".PlatformOrderNotice.status"
PLATFORMORDERNOTICE_STATUS_FIELD.number = 2
PLATFORMORDERNOTICE_STATUS_FIELD.index = 1
PLATFORMORDERNOTICE_STATUS_FIELD.label = 2
PLATFORMORDERNOTICE_STATUS_FIELD.has_default_value = false
PLATFORMORDERNOTICE_STATUS_FIELD.default_value = 0
PLATFORMORDERNOTICE_STATUS_FIELD.type = 5
PLATFORMORDERNOTICE_STATUS_FIELD.cpp_type = 1

PLATFORMORDERNOTICE.name = "PlatformOrderNotice"
PLATFORMORDERNOTICE.full_name = ".PlatformOrderNotice"
PLATFORMORDERNOTICE.nested_types = {}
PLATFORMORDERNOTICE.enum_types = {}
PLATFORMORDERNOTICE.fields = {PLATFORMORDERNOTICE_ORDERID_FIELD, PLATFORMORDERNOTICE_STATUS_FIELD}
PLATFORMORDERNOTICE.is_extendable = false
PLATFORMORDERNOTICE.extensions = {}
...
ECoinBuyRequest = protobuf.Message(ECOINBUYREQUEST)
ECoinBuyResponse = protobuf.Message(ECOINBUYRESPONSE)
ECoinRequest = protobuf.Message(ECOINREQUEST)
ECoinResponse = protobuf.Message(ECOINRESPONSE)
...
PlatformGetGoods = protobuf.Message(PLATFORMGETGOODS)
PlatformOrderNotice = protobuf.Message(PLATFORMORDERNOTICE)
