...
-------------------------------------------------------
--[[
對當前目標造成[倍率](params1)傷害，對該目標賦予[BUFFID](params2)[秒數]秒(params3)
]]--
-------------------------------------------------------
function Skill_4007:castSkill(chaNode, skillType, skillId)
    --紀錄skill data
...
-- 提前計算技能目標用 不使用時回傳nil
function Skill_4007:calSkillTarget(chaNode, skillId)
    return nil
end
function Skill_4007:runSkill(chaNode, skillId, resultTable, allPassiveTable, targetTable, attack_params)
    local skillCfg = ConfigManager:getSkillCfg()[skillId]
...
function Skill_4007:getSkillTarget(chaNode, skillId)
