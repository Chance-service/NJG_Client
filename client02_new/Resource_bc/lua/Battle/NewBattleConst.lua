...
NewBattleConst.PASSIVE_TRIGGER_TYPE = {
    ...
    AURA_DODGE = 106, AURA_ATK_BY_BUFF = 107, AURA_BE_HIT = 108, AURA_DMG = 109, AURA_SET_CRI_PER = 110,
    -- AURA ENEMY
...
NewBattleConst.PASSIVE_TYPE_ID = {
    ...
    -- CD觸發
    [NewBattleConst.PASSIVE_TRIGGER_TYPE.CD] = { 1022, 1072, 1112, 1152, 1202, 1203, 1221, 1232, 10606, 11301, 11406,
                                                 4001, 4002, 4003, 4004, 4005, 50012, 50022, 50026, 50032, 50033 },
    -- 普攻命中時觸發
    ...
    -- 被普攻/傷害技能暴擊命中時觸發
    [NewBattleConst.PASSIVE_TRIGGER_TYPE.BE_CRI_HIT] = { 1223, 50002, 50034 },
    -- 技能附加額外效果
    ...
    -- 普攻必爆
    [NewBattleConst.PASSIVE_TRIGGER_TYPE.ATK_MUST_CRI] = { 10106 },
    -- 普攻附加buff
    [NewBattleConst.PASSIVE_TRIGGER_TYPE.ATK_ADD_BUFF] = { 10106 },
    --
    -- 全場靈氣效果(護盾)
    [NewBattleConst.PASSIVE_TRIGGER_TYPE.AURA_SHIELD] = { 50014 },
    -- 全場靈氣效果(治療量)
    [NewBattleConst.PASSIVE_TRIGGER_TYPE.AURA_HEALTH] = { 50014, 60005 },
    -- 全場靈氣效果(爆擊時)
    [NewBattleConst.PASSIVE_TRIGGER_TYPE.AURA_CRI_HIT] = { 60001, 60004, 60006 },
    -- 全場靈氣效果(無視buff)
    ...
    -- 全場靈氣效果(造成傷害)
    [NewBattleConst.PASSIVE_TRIGGER_TYPE.AURA_DMG] = { 60005 },
    -- 全場靈氣效果(爆擊機率)
    [NewBattleConst.PASSIVE_TRIGGER_TYPE.AURA_SET_CRI_PER] = { 60006 },
    -- 對敵人靈氣效果(治療量)
...
--新手教學戰鬥速度
NewBattleConst.GUIDE_BATTLE_SPEED = 1.5
--戰鬥時間限制(毫秒)
...
NewBattleConst.BUFF = {
    ...
    FREEZE = 51, WEAK = 52, COLLAPSE = 53, SILENCE = 54, BLIND = 55, MAGIC_LOCK = 56, DIZZY = 57, POISON = 58, FROSTBITE = 59, TAUNT = 60,
    ...
    ACCURACY_B = 91, FEAR = 92, EMBER = 93, ICE_WALL = 94, TWINE = 95, BROKEN = 96, EXHAUST = 97, SOUL_OF_POISON = 98, TOXIN_OF_POISON = 99, SNAKE_OF_POISON = 100,
    ...
    EXHAUST_ATTACK = 134, FROSTBITE_ATTACK = 135, BLEED_ATTACK = 136, SOUL_OF_POISON_ATTACK = 137, FIRE1_SKIN_SKILL1 = 138, ATK_HIT = 139, WILL_TO_FIGHT = 140,
    FATE = 141, P_DEF_100 = 142, M_DEF_100 = 143, HYPER_OF_POISON = 144,
    -- 符石
...
NewBattleConst.BUFF_COLOR = {
    ...
    [NewBattleConst.BUFF.POISON] = { ["RED"] = 168, ["GREEN"] = 29, ["BLUE"] = 180, ["ALPHA"] = 255 },
...
NewBattleConst.IS_BATTLE_NEXT = false
