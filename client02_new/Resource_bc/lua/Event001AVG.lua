...
------------------------------------- 功能表
function Event001AVG:onHide(container) --隱藏視窗
...
function Event001AVG:onAuto(container) --自動播放
	--if areaNum == 99 then    --新手教學
	--    MessageBoxPage:Msg_Box_Lan("@NewbieGuideStr152")
	--    return
	--end
...
function Event001AVG:onSilent(container) --靜音
	--if areaNum == 99 then    --新手教學
	--    MessageBoxPage:Msg_Box_Lan("@NewbieGuideStr152")
	--    return
	--end
...
function Event001AVG:onLog(container) --開啟Log
	--if areaNum == 99 then    --新手教學
	--    MessageBoxPage:Msg_Box_Lan("@NewbieGuideStr152")
	--    return
	--end
...
function Event001AVG:onCloseLog(container) --關閉Log
	--if areaNum == 99 then    --新手教學
	--    MessageBoxPage:Msg_Box_Lan("@NewbieGuideStr152")
	--    return
	--end
