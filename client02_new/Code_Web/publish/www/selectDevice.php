...
$sql 	= "SELECT sum() FROM  `recharge`,`player` WHERE  `playerId` =  ".$playerId."  and  create_time > ".$startTime." and create_time < ".$endTime ." and player.id = recharge.playerId order by goodsCost asc, create_time asc, playerId asc";
