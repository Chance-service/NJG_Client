...
CREATE TABLE IF NOT EXISTS `alliance` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='å¸®æ´¾';
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='å†›å›¢ç”³è¯·';
...
CREATE TABLE IF NOT EXISTS `alliance_building` (
  ...
  PRIMARY KEY (`id`),
  KEY `allianceId` (`allianceId`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='å¸®æ´¾å»ºç­‘';
...
CREATE TABLE IF NOT EXISTS `alliance_dynamic` (
  ...
  PRIMARY KEY (`id`),
  KEY `allianceId` (`allianceId`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='å¸®æ´¾åŠ¨æ€';
...
CREATE TABLE IF NOT EXISTS `battle` (
  ...
  `dragonSoulArrayStr` varchar(64) COLLATE utf8_bin DEFAULT '0_0_0_0_0_0_0_0',
  PRIMARY KEY (`id`),
  KEY `playerId_index` (`playerId`) USING BTREE,
...
CREATE TABLE IF NOT EXISTS `distrial_rank` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `fightValue` int(11) DEFAULT NULL COMMENT 'Õ½¶·Á¦',
  `playerId` int(11) DEFAULT NULL,
  `createTime` datetime DEFAULT NULL COMMENT '´´½¨Ê±¼ä',
  `maxPoint` int(11) DEFAULT '0' COMMENT '×î¸ß¹Ø¿¨',
  `rank` int(11) DEFAULT NULL COMMENT 'ÅÅÐÐ',
  `type` int(11) DEFAULT NULL COMMENT 'ÀàÐÍ£º1¹Ø¿¨ÅÅÐÐ£¬2ÉñÃØÅÅÐÐ',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='ÊÔÁ¶ÅÅÐÐ';
...
CREATE TABLE IF NOT EXISTS `player_alliance` (
  ...
  PRIMARY KEY (`playerId`),
  KEY `allianceId` (`allianceId`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='å¸®æ´¾æˆå‘˜';
...
CREATE TABLE IF NOT EXISTS `player_distrial` (
  ...
  `currentCount` int(11) DEFAULT NULL COMMENT 'µ±Ç°ÊÔÁ¶´ÎÊý',
  `currentPoint` int(11) DEFAULT NULL COMMENT 'µ±Ç°¹Ø¿¨',
  `maxPoint` int(11) DEFAULT '0' COMMENT '×î¸ß¹Ø¿¨',
  `npcId` int(11) DEFAULT NULL COMMENT 'µ±Ç°¹Ø¿¨µÄnpcId',
  `historyMaxPoint` int(11) DEFAULT '0' COMMENT 'ÀúÊ·×î¸ß²ãÊý',
  `lightSoul` int(11) DEFAULT '0' COMMENT 'µÆ»ê',
  `attack1` int(11) DEFAULT '0' COMMENT '¹¥»÷¼Ó³É',
  `attack2` int(11) NOT NULL DEFAULT '0',
  `life1` int(11) DEFAULT '0' COMMENT 'ÉúÃü¼Ó³É',
  `life2` int(11) DEFAULT '0',
  `defence1` int(11) DEFAULT '0' COMMENT '·ÀÓù¼Ó³É',
  `defence2` int(11) DEFAULT '0',
  `hidePoints` varchar(500) DEFAULT NULL COMMENT 'Í¨¹ØµÄÒþ²Ø¹Ø¿¨',
  `currentHidePoint` int(11) DEFAULT '0' COMMENT 'µ±Ç°Òþ²Ø¹Ø¿¨',
  `hidePointTime` bigint(20) DEFAULT '0' COMMENT 'Òþ²Ø¹Ø¿¨ÏûÊ§Ê±¼ä',
  `hidePointFightCount` int(11) DEFAULT '0' COMMENT 'Òþ²Ø¹Ø¿¨ÌôÕ½´ÎÊý',
  `updateTime` date DEFAULT NULL COMMENT 'ÉÏ´Î²Ù×÷Ê±¼ä',
  `buyLightSoulCount` int(11) NOT NULL DEFAULT '1' COMMENT '¹ºÂò»êµÆ´ÎÊý',
  `alreadyNpc` text COMMENT 'ÒÑ¾­´ò¹ýµÄnpc',
  `isAddAtrr` int(11) DEFAULT '0' COMMENT 'ÊÇ·ñÒÑ¾­¼ÓÊôÐÔ',
  PRIMARY KEY (`playerId`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='ÓÃ»§ÊÔÁ¶';
...
CREATE TABLE IF NOT EXISTS `rewards` (
  ...
  `rewardInfo` varchar(2048) COLLATE utf8_bin DEFAULT NULL,
