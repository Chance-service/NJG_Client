<?php
class Mod_MooGame_PlatForm_Nduo_getAppFriendsId {
	...
	public function getAppFriendsId($hashData) {
		...
		$rs = $nduo->friends('getAppFriendList', $param);
		...
		if ($rs['status'] != 100) {
			$this->MOD->setMsg('Mod_MooGame_PlatForm_Nduo_getAppFriendsId no data');
			return false;
		}
