<?php
class Mod_MooGame_FightEngine_FightLog_addUnActionLog {
	function addUnActionLog($atkerId) {

		$data['round']		= Mod_MooGame_FightEngine_Control::$turnNum;
		$data['ackUniqueId']		= Mod_MooGame_FightEngine_Control::$ackNum;
		$data['type']		= Mod_MooGame_FightEngine_FightLog::FIGHT_LOG_TYPE_UNACTION;
