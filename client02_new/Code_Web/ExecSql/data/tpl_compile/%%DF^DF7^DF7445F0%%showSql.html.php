<?php /* Smarty version 2.6.18, created on 2015-05-11 11:43:10
         compiled from showSql.html */ ?>
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form">
										...
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-5"><?php echo $this->_tpl_vars['gameName']; ?>
选择渠道</label>
													<div class="col-sm-6">
    ...
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['channelName']):
?>
																<option value="<?php echo $this->_tpl_vars['channelName']; ?>
" ><?php echo $this->_tpl_vars['channelName']; ?>
</option>
...
$("button").click(function(){
	...
	if (!channelName || !serverIds) {
		...
		$.ajax({
			type: "POST",
			url: "index.php?mod=ExecSql&do=doGoRunSql&gameId=<?php echo $this->_tpl_vars['gameId']; ?>
",
			data: param,
			dataType: 'html',
...
window.onload = function(){
    ...
    select.onchange = function(){
       ...
       $.ajax({
    	    type: "POST",
			url: "index.php?mod=ExecSql&do=getServers&appLabel=" + channelName+"&gameId=<?php echo $this->_tpl_vars['gameId']; ?>
",
			data: "",
			dataType: 'html',
			success: function(data) {
