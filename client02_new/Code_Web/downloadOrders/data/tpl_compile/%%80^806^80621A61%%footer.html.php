<?php /* Smarty version 2.6.18, created on 2015-03-24 15:01:45
		...
		<script type="text/javascript">
			if("ontouchend" in document) document.write("<script src='<?php echo $this->_tpl_vars['staticUrl']; ?>
js/jquery.mobile.custom.min.js'>"+"<"+"script>");
		</script>
		<script type="text/javascript" src="<?php echo $this->_tpl_vars['staticUrl']; ?>
js/bootstrap.min.js"></script>
		<script type="text/javascript" src="<?php echo $this->_tpl_vars['staticUrl']; ?>
js/typeahead-bs2.min.js"></script>
		<script type="text/javascript" src="<?php echo $this->_tpl_vars['staticUrl']; ?>
js/fuelux/fuelux.tree.min.js"></script>
<!--  		<script type="text/javascript" src="<?php echo $this->_tpl_vars['staticUrl']; ?>
js/flot/jquery.flot.min.js"></script>  
		<script type="text/javascript" src="<?php echo $this->_tpl_vars['staticUrl']; ?>
js/flot/jquery.flot.resize.min.js"></script> -->
		<script type="text/javascript" src="<?php echo $this->_tpl_vars['staticUrl']; ?>
js/date-time/bootstrap-datepicker.min.js"></script>

		<script type="text/javascript" src="<?php echo $this->_tpl_vars['staticUrl']; ?>
js/jquery.dataTables.min.js"></script>
		<script type="text/javascript" src="<?php echo $this->_tpl_vars['staticUrl']; ?>
js/jquery.dataTables.bootstrap.js"></script>
