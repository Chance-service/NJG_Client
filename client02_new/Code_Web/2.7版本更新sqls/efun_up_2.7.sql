...
ALTER TABLE `msg` ADD COLUMN `jsonType`  int(11) NOT NULL AFTER `content`;
...
ALTER TABLE `status` ADD COLUMN `evaluateRewardsState`  int(11) NOT NULL DEFAULT 0 AFTER `newGuideState`;
ALTER TABLE `status` ADD COLUMN `newbieRewardMonthCard`  int(11) NOT NULL DEFAULT 0 AFTER `evaluateRewardsState`;
