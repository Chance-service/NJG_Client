...
--
-- 导出表中的数据 `cs_user` 账号 admin 密码 admin@wow
--

INSERT INTO `cs_user` (`user_id`, `user_name`, `user_password`, `user_real_name`, `user_role`, `user_games`, `create_time`) VALUES
(1, 'admin', '3c9e24da54081a18c7fec702b4df5a00', '管理员', 1, 'wow', 1419579323);